...
conn.execute("INSERT INTO patients (user_id, full_name, date_of_birth, diagnosis, notes) VALUES (1, 'Jack Ball', '1980-05-09', 'Back Pain', 'Has a lot of back pain, needs help')")
conn.execute("INSERT INTO patients (user_id, full_name, date_of_birth, diagnosis, notes) VALUES (2, 'Big Jane', '1976-07-12', 'Blanching rash', 'HR: 95 regular BP: 70/35 Temp: 40.1C/104.2F RR: 9 O2 Sat: 92% on RA History: Drunk')")
